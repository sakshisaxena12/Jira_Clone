...
export class AddTicketComponent implements OnInit {
  ...
  constructor(private errorHandlingService: ErrorHandlingService,     
    ...
    private router: Router) {
      ...
      let ids = this.route.snapshot.paramMap.get('boardId');
      console.log(ids)
  ...
  this.ticketService.toGetParticularBoard(this.id).subscribe(resp =>{
  ...
  AddTask(data)
  {
    ...
    this.ticketService.TicketDataSave(newdata,this.id ).subscribe(resp => {
